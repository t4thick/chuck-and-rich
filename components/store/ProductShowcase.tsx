    ...
    <section className="page-section bg-white">
      <div className="store-container">
        ...
        {products.length === 0 && !errorMessage ? (
          <div className="mt-10 rounded-3xl border border-dashed border-earth-300 bg-cream px-6 py-16 text-center">
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:gap-6">
